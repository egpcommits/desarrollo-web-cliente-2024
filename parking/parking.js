...
function aparcarVehiculo (tamanio) {
    ...
    if ((coche == 'p') && (comprobarPequenias)) {
        ...
        console.log(`Vehículo aparcado en P${posicionPequenio}`);
    } else if ((coche == 'g') && (comprobarGrandes)) {
        let posicionGrande = plazas[1].indexOf('L');
        plazas[1][posicionGrande] = 'O';
        console.log(`Vehículo aparcado en G${posicionGrande}`);
    } else {
...
function main () {
    ...
    while (!salir) {
        ...
        switch (opcion) {
            ...
            case 4:
                salir = true;
                console.log("Vuelva pronto a los aparcamientos de MOMO");
        }
    }    
}
